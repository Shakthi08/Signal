...
const HomeHeader = (props) => {
  ...
  return(
    <View style={{ flexDirection: 'row', width, marginRight: 20, padding: 10, alignItems: 'center', }}>
      ...
      <Text style={{ flex: 1,textAlign: 'center', fontWeight: 'bold', fontSize: 17, marginLeft: Platform.OS == "ios" ? 50 : 50, }}>Chats</Text>
...
const ChatRoomHeader = (props) => {
  ...
  return(
    <View style={{ flexDirection: 'row', width: Platform.OS == "ios" ? width - 5 : width - 25, marginLeft: -38, padding: 10, alignItems: 'center', justifyContent:'center', }}>
      ...
      <Image source={{ uri: 'https://notjustdev-dummy.s3.us-east-2.amazonaws.com/avatars/4.jpg' }} style={{width: 30, height: 30, borderRadius: 30, marginLeft: Platform.OS == "ios" ? 15 : null}} />
